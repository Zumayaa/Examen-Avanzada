<?php 
  ...
  $categoria = $categoryController->getCategoryById($id);
?>
                          ...
                          <li class="list-group-item px-0 pt-0">
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <p class="mb-0"><?php echo $categoria->name; ?></p>
                              </div>
                            </div>
                          </li>
                          <li class="list-group-item px-0">
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <p class="mb-0"><?php echo $categoria->description; ?></p>
                              </div>
                            </div>
                          </li>
                          <li class="list-group-item px-0">
                            <div class="row">
                              <div class="col-md-6">
                                ...
                                <p class="mb-0"><?php echo $categoria->slug; ?></p>
                              </div>
                            </div>
                          </li>
                        </ul>
